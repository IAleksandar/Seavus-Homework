    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                {
                    Console.WriteLine("Choose a genre by entering a number: ");
                    ...
                    if(Enum.TryParse<Genre>(input1, out Genre genres))
                    {
                        List<Movie> movies = currentCinema.ListOfMovies.Where(x => x.Genre.ToString() == genres.ToString()).ToList();
                        Console.WriteLine($"You have chosen this genre: {genres.ToString()}");
                        ...
                        currentCinema.WatchMovie(movies.FirstOrDefault(x => x.Title.ToLower() == input2.ToLower()));
                    }
                    else
                    {
                        Console.WriteLine("You chose invalid genre.");
                    }
